...
export class Memory extends Component {
    ...
    createGameContainer = () => {
        ...
        for (let i = 0; i < amountCards; i++){
            const div = `<div id="${i+count}" class="memory-card" data-framework="${cardsArrayRandom[i]}"> <div class="front-face"><img src="/games/memory/${cardsArrayRandom[i]}.png" alt="${cardsArrayRandom[i]}" /></div> <div class="back-face"></div> </div>`;
